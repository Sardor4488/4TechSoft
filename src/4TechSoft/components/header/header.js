        ...
        <div className='header'>
          <div className='d-flex w-100  px-5 py-3 d-flex align-items-center justify-content-between'>
            <div className='d-flex'>
              <Link className="d-flex align-items-center logo" to="/">  <h3 className='logo-words  text-dark d-flex align-items-center logo px-0'><span className='text-success'> 4Tech</span> <span className="text-white">Soft</span></h3> </Link>
